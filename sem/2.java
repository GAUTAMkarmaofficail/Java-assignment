...
do{
   ...
   x[i]=sc.nextInt();
      ...
      for(int i=0;i<6;i++)
       ...
       for(int i=0;i<6;i++)
       {
         if(atkt[i]==1)
         {
         System.out.println(sub[i]+":\t"+x[i]+"/50"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
         }
       else
       {
       ...
       for(int i=6;i<8;i++)
       {
         if(atkt[i]==1)
         {
         System.out.println(sub[i]+":\t"+x[i]+"/25"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
         }
       else
       {
    ...
    {      
      ...
      int atkt1[]=new int[8];
        ...
        System.out.println("\033[0m SECOND SEM SUBJECT IS ->");
  ...
  System.out.println("|---------------------------------------------------------------------------------|");
      ...
      for(int i=0;i<6;i++)
       ...
       for(int i=0;i<6;i++)
       {
         if(atkt1[i]==1)
         {
     System.out.println(sub1[i]+":\t"+x1[i]+"/50"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
       ...
       for(int i=6;i<8;i++)
       {
         if(atkt1[i]==1)
         {
   System.out.println(sub1[i]+":\t"+x1[i]+"/25"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
 ...
 for(int i=0;i<8;i++)
  ...
  System.out.println("|---------------------------------------------------------------------------------|");
       System.out.println("| Total\t\t\t\t\t\t\t"+total5+"/350"+"\t\t"+status+"      |");
  System.out.println("|---------------------------------------------------------------------------------|");
       if(cut1>3) 
       {
 ...
 int cut3=0,year1=2;
    int x3[]=new int[8];
      ...
      String sub3[]=new String[8];
        System.out.println("\033[0m THIRD SEM SUBJECT IS ->");
    ...
    System.out.println("|---------------------------------------------------------------------------------|");
      ...
      for(int i=0;i<6;i++)
       ...
       for(int i=0;i<6;i++)
       {
         if(atkt3[i]==1)
         {
System.out.println(sub3[i]+":\t"+x3[i]+"/50"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
 }
       else
       {
      ...
      for(int i=6;i<8;i++)
       {
         if(atkt3[i]==1)
         {
System.out.println(sub3[i]+":\t"+x3[i]+"/25"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
}
       else
       {
 ...
 System.out.println("|\t\t\t \tYou have ATKT in "+cut2+ " subject \t\t\t  |"); 
       System.out.println("|\t\t\t\t   Promoted to "+sem3+ " sem \t\t\t\t  |");
}
     else 
      {   
        System.out.println("|\t\t\t \tYou have ATKT in "+cut2+ " subject \t\t\t  |"); 
...
int x4[]=new int[8+cut2];
      ...
      System.out.println("\033[0m FOUR SEM SUBJECT IS ->");
...
System.out.println("Please Enter marks of 4 sem");
 for(int i=0;i<x4.length;i++)
  ...
  System.out.println("|\033[0;33m---------------------------------------------------------------------------------|");
           System.out.println("\033[0;33m|\t\t\t\t\tD.A.V.V\t\t\t\t          |");  
           System.out.println("|\t\t\t\t\t sem"+sem+"\t\t\t\t          |"); 
  ...
  System.out.println("|---------------------------------------------------------------------------------|");
      ...
      for(int i=0;i<6;i++)
       ...
       for(int i=0;i<6;i++)
       {
         if(atkt4[i]==1)
         {
System.out.println(sub4[i]+":\t"+x4[i]+"/50"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
}
       else
       {
  System.out.println(sub4[i]+":\t"+x4[i]+"/50"+"\t\t\t  |");
       ...
       for(int i=6;i<8;i++)
       {
         if(atkt4[i]==1)
         {
System.out.println(sub4[i]+":\t"+x4[i]+"/25"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
 }
       else
       {
...
int total2=0,cut4=0,sem4=5;
 int cut5=0,year2=3;
   ...
   System.out.println("\033[0m FIVTH SEM SUBJECT IS ->");
...
for(int i=0;i<6;i++)
       {
         if(atkt5[i]==1)
         {
System.out.println(sub5[i]+":\t"+x5[i]+"/50"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
  }
       else
       {
  System.out.println(sub5[i]+":\t"+x5[i]+"/50"+"\t\t\t  |");
       ...
       for(int i=6;i<8;i++)
       {
         if(atkt5[i]==1)
         {
System.out.println(sub5[i]+":\t"+x5[i]+"/25"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
      }
       else
       {
...
System.out.println("|---------------------------------------------------------------------------------|");
 ...
 System.out.println("|\t\t\t \tYou have ATKT in "+cut4+ " subject \t\t\t  |"); 
       System.out.println("|\t\t\t\t   Promoted to "+sem4+ " sem \t\t\t\t  |");
}
...
System.out.println("\033[0m SIX SEM SUBJECT IS ->");
  ...
  for(int i=0;i<6;i++)
       {
         if(atkt6[i]==1)
         {
System.out.println(sub6[i]+":\t"+x6[i]+"/50"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
         }
       else
       {
System.out.println(sub6[i]+":\t"+x6[i]+"/50"+"\t\t\t  |");
       ...
       for(int i=6;i<8;i++)
       {
         if(atkt6[i]==1)
         {
System.out.println(sub6[i]+":\t"+x6[i]+"/25"+"\t\t\u001B[41m ATKT \033[0m\033[0;33m    |");
        }
       else
       {
